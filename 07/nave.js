function Nave(context, teclado, imagem) {
 ...
 Nave.prototype = {
   ...
   novoProcessamentos: function(processamentos) {
      this.processamentos.push(processamentos);
      processamentos.animacao = this;
    },
   retangulosColisao: function() {
      ...
      [
         ...
         {x: this.x + 16, y: this.y + 19, largura: 19, altura: 13},
      ];
